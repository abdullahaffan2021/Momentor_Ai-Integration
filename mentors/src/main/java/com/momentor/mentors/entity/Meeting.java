...
public class Meeting {
    ...
    public List<MeetingAudio> getMeetingAudios() {
        return meetingAudios;
    }

    public void setMeetingAudios(List<MeetingAudio> meetingAudios) {
        this.meetingAudios = meetingAudios;
    }
