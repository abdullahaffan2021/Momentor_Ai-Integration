...
public class TaskController {
    ...
    public TaskResponseDto createTask(@PathVariable Long momid, @Valid @RequestBody TaskRequestDto dto){
        ...
        return new TaskResponseDto(task.getId(),task.getTitle(),task.getAssignedTo(),task.getStatus(),task.isAutoGenerated(),task.isApproved(),task.getResources(),task.getMom().getMeeting().getType());
    }
    ...
    public TaskResponseDto editAiTask(
        ...
        return new TaskResponseDto(
                ...
                task.isApproved(),
                task.getResources(),task.getMom().getMeeting().getType()
        );
    }
